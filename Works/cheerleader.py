...
class Cheerleader:
    ...
    def draw(self):
        ...
        if math.cos(self.dir) < 0:
            if self.speed == 0:
                Cheerleader.images['Idle'][int(self.frame)].composite_draw(0, 'h', sx, sy, 200, 200)
            else:
                Cheerleader.images['Run'][int(self.frame)].composite_draw(0, 'h', sx, sy, 200, 200)
        else:
            if self.speed == 0:
                Cheerleader.images['Idle'][int(self.frame)].draw(sx, sy, 200, 200)
            else:
                Cheerleader.images['Run'][int(self.frame)].draw(sx, sy, 200, 200)
