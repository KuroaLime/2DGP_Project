...
class Hibari:
    ...
    def draw(self):
        ...
        if math.cos(self.dir) < 0:
            if self.speed == 0:
                Hibari.images['Idle'][int(self.frame)].composite_draw(0, 'h', sx, sy, 190, 200)
            else:
                Hibari.images['Walk'][int(self.frame)].composite_draw(0, 'h', sx, sy, 190, 200)
        else:
            if self.speed == 0:
                Hibari.images['Idle'][int(self.frame)].draw(sx, sy, 190, 200)
            else:
                Hibari.images['Walk'][int(self.frame)].draw(sx, sy, 190, 200)
