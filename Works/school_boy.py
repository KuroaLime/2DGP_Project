...
class School_boy:
    ...
    def draw(self):
        ...
        if math.cos(self.dir) < 0:
            if self.speed == 0:
                School_boy.images['Idle'][int(self.frame)].composite_draw(0, 'h', self.x, self.y, 190, 200)
            else:
                School_boy.images['Walk'][int(self.frame)].composite_draw(0, 'h', self.x, self.y, 190, 200)
        else:
            if self.speed == 0:
                School_boy.images['Idle'][int(self.frame)].draw(self.x, self.y, 190, 200)
            else:
                School_boy.images['Walk'][int(self.frame)].draw(self.x, self.y, 190, 200)
