    ...
    def load_images(self):
        if Misuzu.images == None:
            ...
            for name in animation_names:
                Misuzu.images[name] = [load_image("./Resource/classification/Boss/Misuzu/Occupied/"+ name + " (%d)" % i + ".png") for i in range(1, 10)]

    def prepare_patrol_points(self):
        positions = [(800, 750), (1118, 750), (1050, 530), (575, 220), (235, 33), (575,220), (1050, 530), (1118,750)]
        self.patrol_points = []
        for p in positions:
